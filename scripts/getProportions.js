      ...
      for (let thirdPoint = 0; thirdPoint < data.length; thirdPoint += 1) {
        for (let fourthPoint = 0; fourthPoint < data.length; fourthPoint += 1) {
          ...
          const dist2 = Math.sqrt(
            Math.pow((data[thirdPoint][0] - data[fourthPoint][0]), 2) +
            Math.pow((data[thirdPoint][1] - data[fourthPoint][1]), 2) +
            Math.pow((data[thirdPoint][2] - data[fourthPoint][2]), 2)
          );
